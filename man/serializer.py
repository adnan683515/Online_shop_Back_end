...
from product_app.models import view_model,warenty_watch
...
class warenty_watches_serialzier(serializers.ModelSerializer):
    class Meta:
        model = warenty_watch
        fields = '__all__'
...
class jacketSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id','cetagory','type_your_product','TypeOFJacket','Brand','product_title','display_image','font_image','back_image','quantity','range_of_price','fixed_price','colour','country','size','warenty_watch','description','MainMetariails','abailable','eyes']
...
class WatchSerializer(serializers.ModelSerializer):
    ...
    range_of_price = serializers.CharField(read_only=True)
    warenty_watch = serializers.CharField(read_only=True)
