...
class warenty_watch(models.Model):
...
class Product(models.Model):
    ...
    display_image = models.ImageField(upload_to='display_pic/',null=True,blank=True)
    font_image = models.ImageField(upload_to='display_pic/',null=True,blank=True)
    back_image = models.ImageField(upload_to='display_pic/',null=True,blank=True)
    ...
    warenty_watch = models.ForeignKey(warenty_watch,on_delete=models.CASCADE,null=True,blank=True)
    Movement_Watch = models.ForeignKey(Movement_Watch,on_delete=models.CASCADE,null=True,blank=True)
    description = models.TextField(null=True,blank=True)
    abailable = models.CharField(max_length=100,null=True,blank=True)
